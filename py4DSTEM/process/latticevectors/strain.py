...
def get_strain_from_reference_g1g2(g1g2_map, g1, g2):
    ...
    Returns:
        ...
        matrix, in the following 5 arrays:
            ...
            * ``strain_map.slices['e_xx']``: change in lattice x-components with respect
              to x
            * ``strain_map.slices['e_yy']``: change in lattice y-components with respect
              to y
            * ``strain_map.slices['e_xy']``: change in lattice x-components with respect
              to y
            * ``strain_map.slices['theta']``: rotation of lattice with respect to
              reference
...
def get_rotated_strain_map(unrotated_strain_map, xaxis_x, xaxis_y):
    ...
    Returns:
        ...
        rotated_strain_map.slices['e_xx'] element oriented along the new coordinate
        system
    """
