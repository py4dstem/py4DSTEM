...
# py4DSTEM processing pipelines are saved as .h5 files with the save_datacube() function,
# which accepts a RawDataCube, and spit out a .h5 file.  The default behavior is to save the 
...
class DataCube(DataObject):
    ...
    def __init__(self, data, parentDataCube, **kwargs):
        ...
        if not np.all([key in self.__dict__.keys() for key in ['R_Nx','R_Ny','Q_Nx','Q_Ny']]):
...
class RawDataCube(DataCube):
    ...
    def __init__(self, data, R_Nx, R_Ny, Q_Nx, Q_Ny,
