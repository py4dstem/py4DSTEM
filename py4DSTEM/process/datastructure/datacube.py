...
#
# Datacube objects can be generated by the read_data() function, which accepts a filepath and 
# outputs a Datacube.
# Datacube objects are saved as .h5 files. The save_from_datacube() function accepts a Datacube, 
# and spit out a .h5 file.
#
#
### A note on metadata ##
