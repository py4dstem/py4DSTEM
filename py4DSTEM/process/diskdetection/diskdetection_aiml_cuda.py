...
from .diskdetection_aiml import _get_latest_model, _integrate_disks
...
def find_Bragg_disks_aiml_CUDA(datacube, probe,
    ...
    This method utilizes crystal4D network to predict Bragg disks from diffraction images.
