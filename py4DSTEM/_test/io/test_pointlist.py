...
with h5py.File(fp,'r') as f:
    ...
    exists = py4DSTEM.io.datastructure.EMD_group_exists(
        ...
        py4DSTEM.io.datastructure.EMD_group_types['PointList'],
        'test_pointlist')
    pl = py4DSTEM.io.datastructure.PointList.from_h5(grp['test_pointlist'])
...
with h5py.File(fp,'r') as f:
    ...
    names = py4DSTEM.io.datastructure.find_EMD_groups(
        ...
        py4DSTEM.io.datastructure.EMD_group_types['PointList'])
    print(names)
    pl4 = py4DSTEM.io.datastructure.PointList.from_h5(grp['PointList0'])
    pl5 = py4DSTEM.io.datastructure.PointList.from_h5(grp['PointList1'])
